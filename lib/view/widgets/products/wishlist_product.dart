...
class WishlistItem extends StatelessWidget {
  ...
  const WishlistItem({super.key, required this.wishlistModel});
  ...
  Widget build(BuildContext context) {
    ...
    //to get only WishlistProduct from products list
    HomeProvider homeProvider = HomeProvider.get(context);
    ProductModel? product =
        homeProvider.getProductById(productId: wishlistModel.productId!);
